...
#define NFC_SYS_FREQUENCY           27120000        /* 系统运行时钟，单位HZ */

#define MAIN_PWM_TIM                1               /* 发送的nfc基本波形的高级定时器，1即为TIM1 */
#define MAIN_PWM_TIM_CCx            1               /* 发送的nfc基本波形的高级定时器的通道 */
#define MAIN_PWM_TIM_CHx_GPIOx      GPIOC           /* 发送的nfc基本波形的高级定时器的通道对应的GPIO组 */
...
#define CTRL_REC_TIM_CHx_GPIOx      GPIOD           /* 接收的nfc波形的定时器的通道对应的GPIO组 */
#define CTRL_REC_TIM_CHx_PIN        GPIO_Pin_4      /* 接收的nfc波形的定时器的通道对应的GPIO PIN */
...
#define NFC_OPA_CHP_GPIOx           GPIOD           /* 芯片集成放大器正向输入端引脚对应的GPIO组 */
#define NFC_OPA_CHP_PIN             GPIO_Pin_7      /* 芯片集成放大器正向输入端引脚对应的GPIO PIN */
#define NFC_OPA_CHN_GPIOx           GPIOD           /* 芯片集成放大器负向输入端引脚对应的GPIO组 */
#define NFC_OPA_CHN_PIN             GPIO_Pin_0      /* 芯片集成放大器负向输入端引脚对应的GPIO PIN */
