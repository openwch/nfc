...
#ifdef SYSCLK_FREQ_HSE
    SetSysClockToHSE();
#elif defined SYSCLK_FREQ_27_12MHz_HSE
...
static void SetSysClockToHSE(void)
{
    ...
    if (HSEStatus == (uint32_t)0x01)
    {
         ...
         *   CH32F20x_D6 (HSE=13.56Mhz)
         *   CH32F20x_D8 (HSE=13.56Mhz)
               *       CH32F20x_D8W (HSE=27.12Mhz)
         */
...
static void SetSysClockTo54_24MHz_HSE(void)
{
    ...
    if (HSEStatus == (uint32_t)0x01)
    {
        ...
        /*  CH32F20x_D6-PLL configuration: PLLCLK = HSE * 4 = 54.24 MHz (HSE=13.56Mhz)
        *  CH32F20x_D8-PLL configuration: PLLCLK = HSE * 4 = 54.24 MHz (HSE=13.56Mhz)
        *  CH32F20x_D8W-PLL configuration: PLLCLK = HSE/2 * 4 = 54.24 MHz(HSE=27.12Mhz)
        */
...
#elif defined SetSysClockTo81_36MHz_HSE
...
static void SetSysClockTo81_36MHz_HSE(void)
{
    ...
    if (HSEStatus == (uint32_t)0x01)
    {
        ...
        /*  CH32F20x_D6-PLL configuration: PLLCLK = HSE * 6 = 81.36 MHz (HSE=13.56Mhz)
        *  CH32F20x_D8-PLL configuration: PLLCLK = HSE * 6 = 81.36 MHz (HSE=13.56Mhz)
        *  CH32F20x_D8W-PLL configuration: PLLCLK = HSE/2 * 6 = 81.36 MHz(HSE=27.12Mhz)
        */
...
static void SetSysClockTo108_48MHz_HSE(void)
{
    ...
    if (HSEStatus == (uint32_t)0x01)
    {
        ...
        /*  CH32F20x_D6-PLL configuration: PLLCLK = HSE * 8 = 108.48 MHz (HSE=13.56Mhz)
        *  CH32F20x_D8-PLL configuration: PLLCLK = HSE * 8 = 108.48 MHz (HSE=13.56Mhz)
        *  CH32F20x_D8W-PLL configuration: PLLCLK = HSE/2 * 8 = 108.48 MHz(HSE=27.12Mhz)
        */
...
static void SetSysClockTo135_6MHz_HSE(void)
{
    ...
    if (HSEStatus == (uint32_t)0x01)
    {
        ...
        /*  CH32F20x_D6-PLL configuration: PLLCLK = HSE * 10 = 135.6 MHz (HSE=13.56Mhz)
         *  CH32F20x_D8-PLL configuration: PLLCLK = HSE * 10 = 135.6 MHz (HSE=13.56Mhz)
         *  CH32F20x_D8W-PLL configuration: PLLCLK = HSE/2 * 10 = 135.6 MHz(HSE=27.12Mhz)
         */
        RCC->CFGR0 &= (uint32_t)((uint32_t)~(RCC_PLLSRC | RCC_PLLXTPRE |
                                             RCC_PLLMULL));
