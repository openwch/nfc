...
static void SetSysClockTo27_12MHz_HSE(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    /*  CH32V20x_D6-PLL configuration: PLLCLK = HSE * 2 = 27.12 MHz (HSE=13.56MHZ)
     *  CH32V20x_D8-PLL configuration: PLLCLK = HSE/4 * 4 = 27.12 MHz (HSE=27.12MHZ)
     *  CH32V20x_D8W-PLL configuration: PLLCLK = HSE/4 * 4 = 27.12 MHz (HSE=27.12MHZ)
     */

#ifdef CH32V20x_D8
    RCC->CFGR0 |= (uint32_t)(RCC_PLLSRC_HSE | RCC_PLLXTPRE_HSE | RCC_PLLMULL4);
#else
    RCC->CFGR0 |= (uint32_t)(RCC_PLLSRC_HSE | RCC_PLLXTPRE_HSE | RCC_PLLMULL2);
#endif
